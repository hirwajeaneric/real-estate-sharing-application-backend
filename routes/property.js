...
const { findById, getAll, add, attachFile, edit, findByLocation, findByMapCoordinates, findByOwnerId, findByPostId, editLatest, findByStatus, remove, upload } = require('../controllers/property');
...
router.put('/updateLatest', editLatest);
